                        ...
                        if(parameters.where && parameters.where != 'undefined') {
                            ...
                            if(whereColumns.length) {
                                ...
                                for (var i = 0; i < whereColumns.length; i++) {
                                    ...
                                    if(reference.base.name === 'mysql') fn.sql += column + signal + (parameters.where[column] === null ? "NULL" : "?");
                                    if(reference.base.name === 'mssql') fn.sql += column + signal + (parameters.where[column] === null ? "NULL" : ("@" + column));
                                }
                        ...
                        if(parameters && parameters.where && parameters.where != 'undefined') {
                            ...
                            if(whereColumns.length) {
                                ...
                                for (var i = 0; i < whereColumns.length; i++) {
                                    ...
                                    if(reference.base.name === 'mysql') fn.where.sqlColumns += column + signal + (parameters.where[column] === null ? "NULL" : "?");
                                    if(reference.base.name === 'mssql') fn.where.sqlColumns += column + signal + (parameters.where[column] === null ? "NULL" : ("@" + column));
                                }
