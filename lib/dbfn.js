                        ...
                        if(parameters.where && parameters.where != 'undefined') {
                            ...
                            if(whereColumns.length) {
                                ...
                                for (var i = 0; i < whereColumns.length; i++) {
                                    ...
                                    if(reference.base.name === 'mysql') fn.sql += column + signal + (parameters.where[whereColumns[i]] === null ? "NULL" : "?");
                                    if(reference.base.name === 'mssql') fn.sql += column + signal + (parameters.where[whereColumns[i]] === null ? "NULL" : ("@" + column));
                                }
